...
This module provides an interface to the Segment Anything Model (SAM) from ultralytics_mhaf, designed for real-time image
...
from ultralytics_mhaf.utils.torch_utils import model_info
