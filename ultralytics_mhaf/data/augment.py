...
from ultralytics_mhaf.utils import LOGGER, colorstr
from ultralytics_mhaf.utils.checks import check_version
from ultralytics_mhaf.utils.instance import Instances
from ultralytics_mhaf.utils.metrics import bbox_ioa
from ultralytics_mhaf.utils.ops import segment2box, xyxyxyxy2xywhr
from ultralytics_mhaf.utils.torch_utils import TORCHVISION_0_10, TORCHVISION_0_11, TORCHVISION_0_13
...
class DyCacheMixUp(BaseMixTransform):
    ...
    def _mix_transform(self, labels):
        ...
        # else:
        #     self.idx2 += 1
        #     print(self.idx1 / (self.idx1 + self.idx2))
        return labels
