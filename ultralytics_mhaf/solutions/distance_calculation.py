...
from ultralytics_mhaf.utils.checks import check_imshow
from ultralytics_mhaf.utils.plotting import Annotator, colors
...
class DistanceCalculation:
    ...
    def display_frames(self):
        """Display frame."""
        cv2.namedWindow("ultralytics_mhaf Distance Estimation")
        cv2.setMouseCallback("ultralytics_mhaf Distance Estimation", self.mouse_event_for_distance)
        cv2.imshow("ultralytics_mhaf Distance Estimation", self.im0)
