...
from ultralytics_mhaf.cfg import TASK2DATA, TASK2METRIC, get_save_dir
from ultralytics_mhaf.utils import DEFAULT_CFG, DEFAULT_CFG_DICT, LOGGER, NUM_THREADS, checks
...
def run_ray_tune(
    ...
    LOGGER.info("💡 Learn about RayTune at https://docs.ultralytics_mhaf.com/integrations/ray-tune")
