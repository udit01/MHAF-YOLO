...
from ultralytics_mhaf.utils import LOGGER, TryExcept, ops, plt_settings, threaded
...
class Colors:
    """
    ultralytics_mhaf default color palette https://ultralytics_mhaf.com/.

    This class provides methods to work with the ultralytics_mhaf color palette, including converting hex color codes to
    RGB values.
...
class Annotator:
    """
    ultralytics_mhaf Annotator for train/val mosaics and JPGs and predictions annotations.
...
@TryExcept()  # known issue https://github.com/ultralytics_mhaf/yolov5/issues/5395
@plt_settings()
...
def save_one_box(xyxy, im, file=Path("im.jpg"), gain=1.02, pad=10, square=False, BGR=False, save=True):
    ...
    Example:
        ```python
        from ultralytics_mhaf.utils.plotting import save_one_box
    ...
    if save:
        ...
        # cv2.imwrite(f, crop)  # save BGR, https://github.com/ultralytics_mhaf/yolov5/issues/7007 chroma subsampling issue
...
def plot_results(file="path/to/results.csv", dir="", segment=False, pose=False, classify=False, on_plot=None):
    ...
    Example:
        ```python
        from ultralytics_mhaf.utils.plotting import plot_results
