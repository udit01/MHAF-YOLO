...
from ultralytics_mhaf.utils.tal import TORCH_1_10, dist2bbox, dist2rbox, make_anchors
...
class Detect(nn.Module):
    ...
    def __init__(self, nc=80, ch=()):
        ...
        # self.cv3 = nn.ModuleList(nn.Sequential(DWConv(x, c3, 3), UniRepLKNetBlock(c3, 5), nn.Conv2d(c3, self.nc, 1)) for x in ch)
        self.cv3 = nn.ModuleList(nn.Sequential(UniRepLKNetBlock(x, 5), Conv(x, c3, 1), nn.Conv2d(c3, self.nc, 1)) for x in ch)
    ...
    def inference(self, x):
        ...
        if self.export and self.format in ("tflite", "edgetpu"):
            ...
            # See https://github.com/ultralytics_mhaf/ultralytics_mhaf/issues/7371
            grid_h = shape[2]
            grid_w = shape[3]
...
class RTDETRDecoder(nn.Module):
    ...
    def forward(self, x, batch=None):
        ...
        from ultralytics_mhaf.models.utils.ops import get_cdn_group
