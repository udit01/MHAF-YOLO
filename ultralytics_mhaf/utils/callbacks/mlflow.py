...
"""
MLflow Logging for ultralytics_mhaf YOLO.

This module enables MLflow logging for ultralytics_mhaf YOLO. It logs metrics, parameters, and model artifacts.
...
from ultralytics_mhaf.utils import LOGGER, RUNS_DIR, SETTINGS, TESTS_RUNNING, colorstr
...
def on_pretrain_routine_end(trainer):
    ...
    Args:
        trainer (ultralytics_mhaf.engine.trainer.BaseTrainer): The training object with arguments and parameters to log.
