...
from ultralytics_mhaf.utils import LOCAL_RANK, NUM_THREADS, TQDM, colorstr, is_dir_writeable
from ultralytics_mhaf.utils.ops import resample_segments
from .augment import Compose, Format, Instances, LetterBox, classify_augmentations, classify_transforms, v8_transforms
from .base import BaseDataset
from .utils import HELP_URL, LOGGER, get_hash, img2label_paths, verify_image, verify_image_label

# ultralytics_mhaf dataset *.cache version, >= 1.0.0 for YOLOv8
...
def load_dataset_cache_file(path):
    """Load an ultralytics_mhaf *.cache dictionary from path."""
    import gc

    gc.disable()  # reduce pickle load time https://github.com/ultralytics_mhaf/ultralytics_mhaf/pull/1585
...
def save_dataset_cache_file(prefix, path, x):
    """Save an ultralytics_mhaf dataset *.cache dictionary x to path."""
