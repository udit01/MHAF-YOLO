...
from ultralytics_mhaf.nn.tasks import RTDETRDetectionModel
...
class RTDETR(Model):
    ...
    def task_map(self) -> dict:
        """
        Returns a task map for RT-DETR, associating tasks with corresponding ultralytics_mhaf classes.

        Returns:
            dict: A dictionary mapping task names to ultralytics_mhaf task classes for the RT-DETR model.
        """
        return {
            "detect": {
