...
from ultralytics_mhaf.models.fastsam.utils import bbox_iou
from ultralytics_mhaf.models.yolo.detect.predict import DetectionPredictor
from ultralytics_mhaf.utils import DEFAULT_CFG, ops


class FastSAMPredictor(DetectionPredictor):
    """
    FastSAMPredictor is specialized for fast SAM (Segment Anything Model) segmentation prediction tasks in ultralytics_mhaf
    YOLO framework.
