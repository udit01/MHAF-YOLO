...
Requirements:
    $ pip install "ultralytics_mhaf[export]"
...
from ultralytics_mhaf.data.dataset import YOLODataset
from ultralytics_mhaf.data.utils import check_det_dataset
from ultralytics_mhaf.nn.autobackend import check_class_names, default_class_names
from ultralytics_mhaf.nn.modules import C2f, Detect, RTDETRDecoder, v10Detect
from ultralytics_mhaf.nn.tasks import DetectionModel, SegmentationModel, WorldModel
...
from ultralytics_mhaf.utils.checks import PYTHON_VERSION, check_imgsz, check_is_path_safe, check_requirements, check_version
from ultralytics_mhaf.utils.downloads import attempt_download_asset, get_github_assets
from ultralytics_mhaf.utils.files import file_size, spaces_in_path
from ultralytics_mhaf.utils.ops import Profile
from ultralytics_mhaf.utils.torch_utils import TORCH_1_13, get_latest_opset, select_device, smart_inference_mode
...
class Exporter:
    ...
    def __call__(self, model=None):
        ...
        if isinstance(model, WorldModel):
            LOGGER.warning(
                ...
                "See https://docs.ultralytics_mhaf.com/models/yolo-world for details."
            )
        ...
        description = f'ultralytics_mhaf {self.pretty_name} model {f"trained on {data}" if data else ""}'
        self.metadata = {
            "description": description,
            "author": "ultralytics_mhaf",
    ...
    def export_engine(self, prefix=colorstr("TensorRT:")):
        ...
        f_onnx, _ = self.export_onnx()  # run before trt import https://github.com/ultralytics_mhaf/ultralytics_mhaf/issues/7016
    ...
    def export_saved_model(self, prefix=colorstr("TensorFlow SavedModel:")):
        ...
        check_version(
            ...
            name="tensorflow",
            verbose=True,
            msg="https://github.com/ultralytics_mhaf/ultralytics_mhaf/issues/5161",
        )
        import onnx2tf
    ...
    def export_edgetpu(self, tflite_model="", prefix=colorstr("Edge TPU:")):
        ...
        LOGGER.warning(f"{prefix} WARNING ⚠️ Edge TPU known bug https://github.com/ultralytics_mhaf/ultralytics_mhaf/issues/1185")
...
class IOSDetectModel(torch.nn.Module):
    """Wrap an ultralytics_mhaf YOLO model for Apple iOS CoreML export."""
