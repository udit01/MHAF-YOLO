...
class NASValidator(DetectionValidator):
    """
    ultralytics_mhaf YOLO NAS Validator for object detection.

    Extends `DetectionValidator` from the ultralytics_mhaf models package and is designed to post-process the raw predictions
