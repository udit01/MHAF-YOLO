...
from ultralytics_mhaf.utils import LOGGER, SETTINGS, TESTS_RUNNING, colorstr

try:
    # WARNING: do not move SummaryWriter import due to protobuf bug https://github.com/ultralytics_mhaf/ultralytics_mhaf/pull/4674
    ...
    from ultralytics_mhaf.utils.torch_utils import de_parallel, torch
