...
using SAM. It forms an integral part of the ultralytics_mhaf framework and is designed for high-performance, real-time image
segmentation tasks.
"""
...
from ultralytics_mhaf.data.augment import LetterBox
from ultralytics_mhaf.engine.predictor import BasePredictor
from ultralytics_mhaf.engine.results import Results
from ultralytics_mhaf.utils import DEFAULT_CFG, ops
...
class Predictor(BasePredictor):
    ...
    def setup_model(self, model, verbose=True):
        ...
        parameters for image normalization and other ultralytics_mhaf compatibility settings.
        ...
        # ultralytics_mhaf compatibility settings
        self.model.pt = False
