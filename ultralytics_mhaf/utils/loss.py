...
from ultralytics_mhaf.utils.metrics import OKS_SIGMA
from ultralytics_mhaf.utils.ops import crop_mask, xywh2xyxy, xyxy2xywh
from ultralytics_mhaf.utils.tal import RotatedTaskAlignedAssigner, TaskAlignedAssigner, dist2bbox, dist2rbox, make_anchors
from ultralytics_mhaf.utils.atss import ATSSAssigner
    ...
    def __call__(self, preds, batch):
        ...
        try:
            ...
            raise TypeError(
                ...
                "as an example.\nSee https://docs.ultralytics_mhaf.com/datasets/segment/ for help."
            ) from e
    ...
    def __call__(self, preds, batch):
        ...
        try:
            ...
            raise TypeError(
                ...
                "as an example.\nSee https://docs.ultralytics_mhaf.com/datasets/obb/ for help."
            ) from e
